...
public class Utils {
    ...
    public static void saveSettings(String player1, String player2, int size) {
    ...
    public static String[] loadSettings() {
        try (Scanner fileScanner = new Scanner(new File("settings.txt"))) {
            ...
            return new String[]{player1, player2, String.valueOf(size)};
        } catch (Exception e) {
            return new String[]{"гравець1", "гравець2", "3"};
        }
    }

    public static void saveStats(String winner, String player1, String player2, int size) {
        try (FileWriter fw = new FileWriter("stats.txt", true)) {
            fw.write("дата: " + new java.util.Date() + ", розмір: " + size +
                    ", гравець1: " + player1 + ", гравець2: " + player2 + ", переможець: " + winner + "\n");
        } catch (Exception e) {
